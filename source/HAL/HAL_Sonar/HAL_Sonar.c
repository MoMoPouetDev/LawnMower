...
uint8_t HAL_Sonar_GetDistance(void);
...
void HAL_Sonar_Distance()
{
    ...
    switch (u8_sonarState)
    {
        ...
        case 1:
            ...
            if (u8_echoState == 2)
            {
                _uDistanceSonarFC = HAL_Sonar_GetDistance();
                u8_sonarState = 2;
            }
            break;
        ...
        case 3:
            ...
            if (u8_echoState == 2)
            {
                _uDistanceSonarFL = HAL_Sonar_GetDistance();
                u8_sonarState = 4;
            }
            break;
        ...
        case 5:
            ...
            if (u8_echoState == 2)
            {
                _uDistanceSonarFR = HAL_Sonar_GetDistance();
                u8_sonarState = 0;
            }
            break;
